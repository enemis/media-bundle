...
use Enemis\MediaBundle\CDN\CDNInterface;
use Enemis\MediaBundle\Extra\ApiMediaFile;
use Enemis\MediaBundle\Filesystem\Local;
use Enemis\MediaBundle\Generator\GeneratorInterface;
use Enemis\MediaBundle\Metadata\MetadataBuilderInterface;
use Enemis\MediaBundle\Model\MediaInterface;
use Enemis\MediaBundle\Thumbnail\ThumbnailInterface;
...
class FileProvider extends BaseProvider implements FileProviderInterface
{
    ...
    public function getDownloadResponse(MediaInterface $media, $format, $mode, array $headers = [])
    {
        ...
        if (!$this->getFilesystem()->getAdapter() instanceof Local) {
            throw new \RuntimeException('Cannot use X-Sendfile or X-Accel-Redirect with non \Enemis\MediaBundle\Filesystem\Local');
        }
